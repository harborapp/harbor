DIST := dist
BIN := bin
EXECUTABLE := harbor-api
IMAGE := harborapp/harbor-api
SHA := $(shell git rev-parse --short HEAD)

LDFLAGS += -X "github.com/harborapp/harbor-api/config.VersionDev=$(SHA)"
...
GENERATE ?= github.com/harborapp/harbor-api/assets \
