...
import (
	...
	"github.com/umschlag/umschlag-api/pkg/api/v1/restapi/operations/auth"
	"github.com/umschlag/umschlag-api/pkg/api/v1/restapi/operations/profile"
	"github.com/umschlag/umschlag-api/pkg/api/v1/restapi/operations/team"
	"github.com/umschlag/umschlag-api/pkg/api/v1/restapi/operations/user"
)

//go:generate gorunpkg github.com/go-swagger/go-swagger/cmd/swagger generate server --target ../../v1 --name Umschlag --spec ../../../../assets/apiv1.yml --exclude-main

func configureFlags(api *operations.UmschlagAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.UmschlagAPI) http.Handler {
