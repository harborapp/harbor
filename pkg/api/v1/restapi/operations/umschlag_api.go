...
// NewUmschlagAPI creates a new Umschlag instance
func NewUmschlagAPI(spec *loads.Document) *UmschlagAPI {
	return &UmschlagAPI{
...
/*UmschlagAPI API definition for Umschlag */
type UmschlagAPI struct {
	spec            *loads.Document
...
func (o *UmschlagAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *UmschlagAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *UmschlagAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *UmschlagAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *UmschlagAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *UmschlagAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *UmschlagAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the UmschlagAPI
func (o *UmschlagAPI) Validate() error {
...
func (o *UmschlagAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *UmschlagAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *UmschlagAPI) Authorizer() runtime.Authorizer {
...
func (o *UmschlagAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
func (o *UmschlagAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *UmschlagAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the umschlag API
func (o *UmschlagAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *UmschlagAPI) initHandlerCache() {
...
func (o *UmschlagAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *UmschlagAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *UmschlagAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
